...
The mass defect is closed related to <span style="color:Salmon">nuclear binding energy</span>. If we divide the above energy by 12 and times 931.5 MeV/amu, we obtain the bind energy per neucleio for ^12^C is 7.67 (see Figure \@ref(fig:stability)) 
