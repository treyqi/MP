...
{\centering \includegraphics{figures/isotope_halflife} 
...
bind energy per neuleio for \textsuperscript{12}C is 7.67 (see figure
below)
...
\caption{Nuclear binding energy per nucleon (The image is from [wiki](https://commons.wikimedia.org/wiki/File:Binding_energy_curve_-_common_isotopes.svg))}\label{fig:unnamed-chunk-4}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{figures/x-ray_hand.gif}
