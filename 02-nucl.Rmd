...
<p class='FOO'> $\underline{\text{Example 2.2}}$ For a Co-60 source, what is the activity in GBq of a sample containing 10^16^ atoms? <br><br> Using Eq. \@ref(eq:activity-decayconstant) or \@ref(eq:half-life)
\begin{aligned}
...
<p class='FOO'> $\underline{\text{Example 2.3}}$ What is the total number of decays of 1 mCi Cs-137?<br><br> Using \@ref(eq:total-decay), the number of decays is 1.44$\times$(30 yr)$\times$(3.15$\times 10^7$ s/yr)$\times$(3.7$\times10^7$ decay/s) = 5.0$\times 10^{16}$.</p>
